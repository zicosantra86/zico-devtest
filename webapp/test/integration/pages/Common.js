sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("au/com/bournedigital/app", ".html");
			sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

			if (sHash) {
				sHash = "#DeveloperTest-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
			} else {
				sHash = "#DeveloperTest-display";
			}

			return sUrl + sUrlParameters + sHash;
		}

		return Opa5.extend("au.com.bournedigital.developertest.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["au/com/bournedigital/localService/mockserver"], function (mockserver) {
